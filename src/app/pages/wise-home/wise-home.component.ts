...
export class WiseHomeComponent {
  ...
  public showOffTabletsImages = [
    '/assets/wise-home/Mobile/Show off tablets/1.png',
    '/assets/wise-home/Mobile/Show off tablets/2.png',
    '/assets/wise-home/Mobile/Show off tablets/3.png',
