...
export class BeautyZoneComponent implements OnInit {
  ...
  public texts: { [key: string]: string } = {
    ...
    firstPersona: `Chloe is a freelance bridal & evening makeup artist. 
      ...
      Still, she feels frustrated when she has to use more than one platform to post all of her content. Also, those platforms don’t support tagging specific products – which leads to tons of comments and messages that she doesn’t have the time for. `,
